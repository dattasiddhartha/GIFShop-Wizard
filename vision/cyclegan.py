...
def CYCLEGAN(destination_style, source_image, uniqueID):
    """
    ...
    if destination_style == "horse2zebra":
        subprocess.run("python ./vision/cycle_gan/test.py --dataroot "+str(source_image)+" --name horse2zebra --model test --no_dropout")
