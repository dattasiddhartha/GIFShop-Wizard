...
from vision.gifedit import stitchImages, stitch_FST_Images_ServerStyle, stitch_partialFST_Images_ServerStyle, stitch_FR
...
def fast_style_transfer(recipient_id, style):
    """
