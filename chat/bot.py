...
class Bot:
    ...
    def send_attachment_local(
        ...
        return self.send_message(
            recipient_id,
            {
                "attachment": {"type": attachment_type, "payload": {}},
                "filedata": (
                    os.path.basename(attachment_path),
                    open(attachment_path, "rb"),
                ),
    ...
    def send_button_message(
        self, recipient_id, text, buttons, notification_type=NotificationType.regular
    ):
        """Send text messages to the specified recipient.
    ...
    def send_action(
        self, recipient_id, action, notification_type=NotificationType.regular
    ):
    ...
    def send_quick_reply_test(self, recipient_id):
        print(f"I'm here: {recipient_id}")
        params = {
        ...
        r = requests.post(
            f"https://graph.facebook.com/v7.0/me/messages?access_token={self.access_token}",
            params=params,
            data=payload,
    ...
    def QuickReply_Send(self, user_id, text, reply_payload):
        ...
        payload = {
            ...
            "message": {"text": "{}".format(text), "quick_replies": reply_payload,},
        }
        requests.post(
    ...
    def send_quickreply(self, recipient_id, quick_reply_message, reply_options):
        ...
        reply_payload = Bot.QuickReply_CreatePayload(reply_options)
        Bot.QuickReply_Send(
            self=self,
    ...
    def GetStartedButton_createBtn(self):
        ...
        payload = json.dumps({"get_started": {"payload": "@get_started"}})
